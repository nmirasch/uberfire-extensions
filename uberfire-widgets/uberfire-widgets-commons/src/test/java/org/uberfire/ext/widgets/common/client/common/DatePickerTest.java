...
public class DatePickerTest {
    ...
    public void testSetFormat() {
        ...
        datePicker.setFormat("en", gwtDateFormat);
        verify(datePickerMock).setLanguage(DatePickerLanguage.EN);
        verify(datePickerMock).setWeekStart(DatePickerDayOfWeek.SUNDAY);
    ...
    @Test
    public void testSetFormatES_ShorMonth() {
        // verify the patch for the incompativility of moth name parsing between DatePickerClientBundle  and the DateTimeFormatInfo
        datePicker = new DatePicker(datePickerMock);
        String gwtDateFormat = "dd/MMM/yyyy";
        datePicker.setFormat("es", gwtDateFormat);
        verify(datePickerMock).setLanguage(DatePickerLanguage.ES);
        verify(datePickerMock).setWeekStart(DatePickerDayOfWeek.MONDAY);
        verify(datePickerMock).setFormat("dd/mm/yyyy"); //No display the name of the month just the number representation
    }

    @Test
    public void testSetFormatES_FullMonth() {
        // verify the patch for the incompativility of moth name parsing between DatePickerClientBundle  and the DateTimeFormatInfo
        datePicker = new DatePicker(datePickerMock);
        String gwtDateFormat = "dd/MMMM/yyyy";
        datePicker.setFormat("es", gwtDateFormat);
        verify(datePickerMock).setLanguage(DatePickerLanguage.ES);
        verify(datePickerMock).setWeekStart(DatePickerDayOfWeek.MONDAY);
        verify(datePickerMock).setFormat("dd/mm/yyyy"); //Not display the name of the month just the number representation
    }

    @Test
    public void testSetFormatDE() {
        // verify the patch for the incompativility of moth name parsing between DatePickerClientBundle  and the DateTimeFormatInfo
        datePicker = new DatePicker(datePickerMock);
        String gwtDateFormat = "dd/MMM/yyyy";
        datePicker.setFormat("de", gwtDateFormat);
    ...
    @Test
    public void testSetFormatFR() {
        datePicker = new DatePicker(datePickerMock);
        String gwtDateFormat = "dd/MMM/yyyy";
        datePicker.setFormat("fr", gwtDateFormat);
